...
<div class="main-page">
			<div class="container" >
				...
				<form action="addplaceDB.jsp" method="post" enctype="multipart/form-data" style="margin-left: 200px;">

<div class="main">
<div class="col-md-8">
<label>States Name</label>
<div class="form-group">
	<select id="state" name="state" class="form-control" style="width: 750px; height: 35px;">
</select>
</div>
</div>
					...
					<div class="col-md-8">
						...
						<div class="form-group">
							...
							<select id="city" name="city" style="width: 750px; height: 35px;"
					...
					<div class="col-md-10">
						...
						<div class="form-group">
							<label for="tabletName">Place Name</label> <input type="text"
								name="placename" id="placename" class="form-control tablet"
								placeholder="Enter Place Name" required> <span
					...
					<div class="col-md-10">
						...
						<div class="form-group">
							<label for="file">Image</label> <input type="file" name="image"
								id="image" class="form-control" placeholder="Choose File"
								required>
						</div>
					</div>
					...
					<div class="col-md-10">
						<div class="form-group">
							<label for="pin code">Pin Code</label> <input type="number"
					...
					<div class="col-md-10">
						<div class="form-group">
							...
							<textarea class="form-control" name="location" id="location"
								placeholder="Enter Location" rows="3" required></textarea>
						</div>
					</div>
					...
					<div class="col-md-10">
						<div class="form-group">
							...
							<textarea class="form-control" name="discription"
								id="discription" placeholder="Enter Description" rows="3"
								required></textarea>
<br><br>
